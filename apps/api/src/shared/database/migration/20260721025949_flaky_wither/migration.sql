...
--> statement-breakpoint
CREATE TABLE "ms_core"."count_points" (
	"id" serial PRIMARY KEY,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "cp_wu_role_source_tag_key" UNIQUE("work_unit_id","role","source_tag"),
	CONSTRAINT "cp_source_tag_cx" CHECK (
...
--> statement-breakpoint
CREATE TABLE "ms_core"."enterprices" (
	"id" serial PRIMARY KEY,
	"region" varchar(10) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"code" varchar(100) NOT NULL,
	"name" varchar(100) NOT NULL,
	CONSTRAINT "enterprices_code_region_key" UNIQUE("code","region")
);
--> statement-breakpoint
...
CREATE TABLE "ms_core"."equipments" (
	...
	"product_signal_tag" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "ms_core"."product_work_unit_specs" (
	"id" serial PRIMARY KEY,
	"product_id" integer NOT NULL,
	"wor_unit_id" integer NOT NULL,
	"uom_id" integer NOT NULL,
	"ideal_rate_per_hour" numeric(15,3) NOT NULL,
	"region" varchar(10) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "pes_product_wu_key" UNIQUE("product_id","wor_unit_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "ms_core"."work_unit_classes" (
	"id" serial PRIMARY KEY,
	"region" varchar(10) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"code" varchar(100) NOT NULL,
	"name" varchar(100) NOT NULL,
	CONSTRAINT "wuc_code_region_key" UNIQUE("code","region")
);
--> statement-breakpoint
CREATE TABLE "ms_core"."work_unit_flows" (
	"id" serial PRIMARY KEY,
	"work_center_id" integer NOT NULL,
	"from_work_unit_id" integer NOT NULL,
	"to_work_unit_id" integer NOT NULL,
	"region" varchar(10) NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "wuf_from_wu_to_wu_keys" UNIQUE("from_work_unit_id","to_work_unit_id"),
	CONSTRAINT "wuf_no_self_loop" CHECK (from_work_unit_id <> to_work_unit_id)
);
--> statement-breakpoint
...
CREATE INDEX "cp_region_updated_idx" ON "ms_core"."count_points" ("region","updated_at");--> statement-breakpoint
CREATE INDEX "cp_wu_id_idx" ON "ms_core"."count_points" ("work_unit_id");--> statement-breakpoint
...
CREATE INDEX "enterprices_region_updated_idx" ON "ms_core"."enterprices" ("region","updated_at");--> statement-breakpoint
...
CREATE INDEX "pes_region_updated_idx" ON "ms_core"."product_work_unit_specs" ("region","updated_at");--> statement-breakpoint
CREATE INDEX "pes_work_unit_id_idx" ON "ms_core"."product_work_unit_specs" ("wor_unit_id");--> statement-breakpoint
CREATE INDEX "pes_product_id_idx" ON "ms_core"."product_work_unit_specs" ("product_id");--> statement-breakpoint
CREATE INDEX "pes_uom_id_idx" ON "ms_core"."product_work_unit_specs" ("uom_id");--> statement-breakpoint
...
CREATE INDEX "wuc_region_updated_idx" ON "ms_core"."work_unit_classes" ("region","updated_at");--> statement-breakpoint
CREATE INDEX "wuf_region_updated_idx" ON "ms_core"."work_unit_flows" ("region","updated_at");--> statement-breakpoint
CREATE INDEX "wuf_wc_id_idx" ON "ms_core"."work_unit_flows" ("work_center_id");--> statement-breakpoint
CREATE INDEX "wuf_to_wu_id_idx" ON "ms_core"."work_unit_flows" ("to_work_unit_id");--> statement-breakpoint
CREATE INDEX "wuf_from_wu_id_idx" ON "ms_core"."work_unit_flows" ("from_work_unit_id");--> statement-breakpoint
...
ALTER TABLE "ms_core"."count_points" ADD CONSTRAINT "count_points_work_unit_id_work_units_id_fkey" FOREIGN KEY ("work_unit_id") REFERENCES "ms_core"."work_units"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "ms_core"."count_points" ADD CONSTRAINT "count_points_equipment_id_equipments_id_fkey" FOREIGN KEY ("equipment_id") REFERENCES "ms_core"."equipments"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "ms_core"."product_work_unit_specs" ADD CONSTRAINT "product_work_unit_specs_product_id_products_id_fkey" FOREIGN KEY ("product_id") REFERENCES "ms_core"."products"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "ms_core"."product_work_unit_specs" ADD CONSTRAINT "product_work_unit_specs_wor_unit_id_work_units_id_fkey" FOREIGN KEY ("wor_unit_id") REFERENCES "ms_core"."work_units"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "ms_core"."product_work_unit_specs" ADD CONSTRAINT "product_work_unit_specs_uom_id_uom_id_fkey" FOREIGN KEY ("uom_id") REFERENCES "ms_core"."uom"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "ms_core"."work_unit_flows" ADD CONSTRAINT "work_unit_flows_work_center_id_work_centers_id_fkey" FOREIGN KEY ("work_center_id") REFERENCES "ms_core"."work_centers"("id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "ms_core"."work_unit_flows" ADD CONSTRAINT "work_unit_flows_from_work_unit_id_work_units_id_fkey" FOREIGN KEY ("from_work_unit_id") REFERENCES "ms_core"."work_units"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "ms_core"."work_unit_flows" ADD CONSTRAINT "work_unit_flows_to_work_unit_id_work_units_id_fkey" FOREIGN KEY ("to_work_unit_id") REFERENCES "ms_core"."work_units"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "ms_core"."work_units" ADD CONSTRAINT "work_units_work_center_id_work_centers_id_fkey" FOREIGN KEY ("work_center_id") REFERENCES "ms_core"."work_centers"("id") ON DELETE RESTRICT;--> statement-breakpoint
ALTER TABLE "ms_core"."work_units" ADD CONSTRAINT "work_units_work_unit_class_id_work_unit_classes_id_fkey" FOREIGN KEY ("work_unit_class_id") REFERENCES "ms_core"."work_unit_classes"("id") ON DELETE RESTRICT;